...
export const blockSweeperDeployments = {
  [celoSepolia.id]: {
    ...
    proxyAddress: (env.registryAddressCeloSepolia || "0xe8701E0C2cdb6708d98343572E63CFe7118A62C8") as Address,
  ...
  [celo.id]: {
    chainId: celo.id,
    proxyAddress: env.registryAddressCelo ? (env.registryAddressCelo as Address) : undefined,
